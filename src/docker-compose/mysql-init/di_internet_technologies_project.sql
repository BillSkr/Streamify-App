...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2025 at 10:12 PM
...
--
-- Dumping data for table `content_lists`
--
...
--
-- Indexes for table `content_lists`
--
...
--
-- AUTO_INCREMENT for table `content_lists`
--
ALTER TABLE `content_lists`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Constraints for table `content_lists`
--
ALTER TABLE `content_lists`
